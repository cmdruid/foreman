...
pub const FOREMAN_LOCK_FILENAME: &str = "foreman.lock";
...
pub const JOB_EVENT_CHANNEL_CAPACITY: usize = 512;
...
pub const ROUTE_AGENT_LOGS: &str = "/agents/{id}/logs";
...
pub const ROUTE_AGENT_RETRY: &str = "/agents/{id}/retry";
...
pub const ROUTE_PROJECT_JOBS_PLAN: &str = "/projects/{id}/jobs/plan";
...
pub const ROUTE_JOB_EVENTS: &str = "/jobs/{id}/events";
...
pub const AGENT_STATUS_BLOCKED: &str = "blocked";
...
pub const ERROR_CODE_CFG_PROJECT_ARG_REQUIRED: &str = "CFG_PROJECT_ARG_REQUIRED";
pub const ERROR_CODE_CFG_PROJECT_PATH_INVALID: &str = "CFG_PROJECT_PATH_INVALID";
pub const ERROR_CODE_CFG_PROJECT_PARSE: &str = "CFG_PROJECT_PARSE";
pub const ERROR_CODE_CFG_PROJECT_VALIDATION: &str = "CFG_PROJECT_VALIDATION";
pub const ERROR_CODE_CFG_PROJECT_UNKNOWN_KEY: &str = "CFG_PROJECT_UNKNOWN_KEY";
pub const ERROR_CODE_CFG_CALLBACK_PROFILE_MISSING: &str = "CFG_CALLBACK_PROFILE_MISSING";
pub const ERROR_CODE_CFG_RUNTIME_IO: &str = "CFG_RUNTIME_IO";
pub const ERROR_CODE_CFG_SERVICE_INVALID: &str = "CFG_SERVICE_INVALID";
pub const ERROR_CODE_WK_DOCTOR_FAILED: &str = "WK_DOCTOR_FAILED";
pub const ERROR_CODE_CB_COMMAND_INVALID: &str = "CB_COMMAND_INVALID";
