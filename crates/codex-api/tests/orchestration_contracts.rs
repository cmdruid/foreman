...
"#
    ...
    assert_eq!(steer_request["params"]["threadId"], "thread-1");
    assert_eq!(steer_request["params"]["expectedTurnId"], "turn-1");
    ...
    assert_eq!(interrupt_request["params"]["threadId"], "thread-1");
    assert_eq!(interrupt_request["params"]["turnId"], "turn-2");
}
